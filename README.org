...
$$ \Rightarrow v\frac{e^{\frac{\lambda}{m} t} - ke^{\frac{\lambda}{m}c}}{e^{\frac{\lambda}{m} c}} - \lambda = 0 $$
...
\begin{equation}
  \begin{cases}
    ...
    \zeta(\lambda) = v_3\frac{e^{\frac{\lambda}{m} t_3} - ke^{\frac{\lambda}{m}c_3}}{e^{\frac{\lambda}{m} c_3}} - \lambda \\
    ...
    \phi(W) = \frac{\sqrt{4kW-\lambda^2}}{2m}(c_4 - t_4) - \arctan(\frac{2kv_4 + \lambda}{\sqrt{4kW - \lambda^2}}) \\
