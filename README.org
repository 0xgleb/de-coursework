...
$$ \Rightarrow v = \sqrt{\frac{B}{k}} \tan \frac{c_2(B) - \sqrt{kB}t}{m} $$
$$ \Rightarrow v\sqrt{\frac{k}{B}} = \tan \frac{c_2(B) - \sqrt{kB}t}{m} $$
$$ \mbox{Let } \lambda(B) = v\sqrt{\frac{k}{B}} - \tan \frac{c_2(B) - \sqrt{kB}t}{m} $$
$$  $$
