...
#+INCLUDE: "./optimizer/src/SecondModel.hs" src haskell

And I changed the main module because now I get only one set of parameters from the code.

#+INCLUDE: "./optimizer/app/Main.hs" src haskell
