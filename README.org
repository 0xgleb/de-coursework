...
$$ \mbox{Let } (t_1, v_1), (t_2, v_2), (t_3, v_3) \in S; t_1, t_2, t_3 \in [0, 9]; t_1 \neq t_2 $$
...
$$ v_3 = \frac{\lambda e^{\frac{\lambda}{m} c_3}}{e^{\frac{\lambda}{m} t_3} - ke^{\frac{\lambda}{m}c_3}} $$
$$ v_3\frac{e^{\frac{\lambda}{m} t_3} - ke^{\frac{\lambda}{m}c_3}}{e^{\frac{\lambda}{m} c_3}} = \lambda $$
